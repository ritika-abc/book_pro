                    ...
                    <div class="best-selling p-0">
                        <div class="row">
                          ...
                          $search =  $_POST['search'];
                            ...
                            $sel = "SELECT * FROM `pro` where `title` = '$search' OR   `author`='$search'";
                                    ...
                                    <div class="properties pb-30">
                                        <div class="properties-card">
                                            <div class="properties-img">
                                                <a href="book-details.php?pro_id=<?php echo $row['pro_id'] ?>"><img src="admin/<?php echo $row['image'] ?>" alt></a>
                                            </div>
                                            <div class="properties-caption properties-caption2">
                                                <h3><a href="book-details.php?pro_id=<?php echo $row['pro_id'] ?>$"><?php echo $row['title'] ?></a></h3>
